...
class SohagNephrology extends StatefulWidget {
  const SohagNephrology({Key? key}) : super(key: key);

  @override
  State<SohagNephrology> createState() => _SohagNephrologyState();
}

class _SohagNephrologyState extends State<SohagNephrology> {
