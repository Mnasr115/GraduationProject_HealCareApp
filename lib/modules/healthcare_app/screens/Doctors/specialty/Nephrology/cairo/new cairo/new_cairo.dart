...
class NewCairoNephrology extends StatefulWidget {
  const NewCairoNephrology({Key? key}) : super(key: key);

  @override
  State<NewCairoNephrology> createState() => _NewCairoNephrologyState();
}

class _NewCairoNephrologyState extends State<NewCairoNephrology> {
