...
class NasrCityNephrology extends StatefulWidget {
  const NasrCityNephrology({Key? key}) : super(key: key);

  @override
  State<NasrCityNephrology> createState() => _NasrCityNephrologyState();
}

class _NasrCityNephrologyState extends State<NasrCityNephrology> {
