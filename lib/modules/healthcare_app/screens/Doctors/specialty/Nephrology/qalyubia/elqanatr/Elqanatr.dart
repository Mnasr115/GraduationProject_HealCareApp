...
class ElqanatrNephrology extends StatefulWidget {
  const ElqanatrNephrology({Key? key}) : super(key: key);

  @override
  State<ElqanatrNephrology> createState() => _ElqanatrNephrologyState();
}

class _ElqanatrNephrologyState extends State<ElqanatrNephrology> {
