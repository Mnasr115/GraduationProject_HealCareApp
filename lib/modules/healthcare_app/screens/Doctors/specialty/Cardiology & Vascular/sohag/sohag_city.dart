...
class SohagCardiology extends StatefulWidget {
  const SohagCardiology({Key? key}) : super(key: key);

  @override
  State<SohagCardiology> createState() => _SohagCardiologyState();
}

class _SohagCardiologyState extends State<SohagCardiology> {
                  ...
                  GestureDetector(
                    onTap: (){
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => SohagCardiologyDoc1(),
                        ),
                      );
                    },
                    child: Container(
                  ...
                  GestureDetector(
                    onTap: (){
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => SohagCardiologyDoc2(),
                        ),
                      );
                    },
                    child: Container(
