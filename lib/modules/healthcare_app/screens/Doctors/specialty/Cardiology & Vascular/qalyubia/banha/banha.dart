...
class BanhaCardiology extends StatefulWidget {
  const BanhaCardiology({Key? key}) : super(key: key);

  @override
  State<BanhaCardiology> createState() => _BanhaCardiologyState();
}

class _BanhaCardiologyState extends State<BanhaCardiology> {
                  ...
                  GestureDetector(
                    onTap: (){
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => BenhaCardiologyDoc1(),
                        ),
                      );
                    },
                    child: Container(
                  ...
                  GestureDetector(
                    onTap: (){
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => BenhaCardiologyDoc2(),
                        ),
                      );
                    },
                    child: Container(
                                ...
                                Column(
                                  ...
                                  children: [
                                    ListTile(
                                      ...
                                      title: const Text('Dr.nima ali elmeleigey'),
                                      subtitle: Column(
                                        crossAxisAlignment: CrossAxisAlignment.start,
                                        mainAxisAlignment: MainAxisAlignment.center,
                                        children: [
                  ...
                  GestureDetector(
                    onTap: (){
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => BenhaCardiologyDoc3(),
                        ),
                      );
                    },
                    child: Container(
                                ...
                                Column(
                                  ...
                                  children: [
                                    ListTile(
                                      ...
                                      title: const Text('Dr.tarek helmy abo elazm'),
                                      subtitle: Column(
                                        crossAxisAlignment: CrossAxisAlignment.start,
                                        mainAxisAlignment: MainAxisAlignment.center,
                                        children: [
