...
class ElqanatrCardiology extends StatefulWidget {
  const ElqanatrCardiology({Key? key}) : super(key: key);

  @override
  State<ElqanatrCardiology> createState() => _ElqanatrCardiologyState();
}

class _ElqanatrCardiologyState extends State<ElqanatrCardiology> {
                  ...
                  GestureDetector(
                    onTap: (){
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => ElqanaterCardiologyDoc1(),
                        ),
                      );
                    },
                    child: Container(
                                ...
                                Column(
                                  ...
                                  children: [
                                    ListTile(
                                      ...
                                      title: const Text('Dr.mohamed elbatal'),
                                      subtitle: Column(
                                        crossAxisAlignment: CrossAxisAlignment.start,
                  ...
                  GestureDetector(
                    onTap: (){
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => QanaterCardiologyDoc2(),
                        ),
                      );
                    },
                    child: Container(
                                ...
                                Column(
                                  ...
                                  children: [
                                    ListTile(
                                      ...
                                      title: const Text('Dr.ahmed mansy'),
                                      subtitle: Column(
                                        crossAxisAlignment: CrossAxisAlignment.start,
                                        mainAxisAlignment: MainAxisAlignment.center,
                                        children: [
