...
class QalyubCardiology extends StatefulWidget {
  const QalyubCardiology({Key? key}) : super(key: key);

  @override
  State<QalyubCardiology> createState() => _QalyubCardiologyState();
}

class _QalyubCardiologyState extends State<QalyubCardiology> {
                  ...
                  GestureDetector(
                    onTap: (){
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => QalyubCardiologyDoc1(),
                        ),
                      );
                    },
                    child: Container(
                  ...
                  GestureDetector(
                    onTap: (){
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => QalyubCardiologyDoc2(),
                        ),
                      );
                    },
                    child: Container(
