...
class shoubraCardiology extends StatefulWidget {
  const shoubraCardiology({Key? key}) : super(key: key);

  @override
  State<shoubraCardiology> createState() => _shoubraCardiologyState();
}

class _shoubraCardiologyState extends State<shoubraCardiology> {
                  ...
                  GestureDetector(
                    onTap: (){
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => shoubraCardiologyDoc1(),
                        ),
                      );
                    },
                    child: Container(
                  ...
                  GestureDetector(
                    onTap: (){
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => shoubraCardiologyDoc2(),
                        ),
                      );
                    },
                    child: Container(
