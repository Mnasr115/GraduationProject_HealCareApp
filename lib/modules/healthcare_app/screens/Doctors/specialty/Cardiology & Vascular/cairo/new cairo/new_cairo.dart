...
class NewCairoCardiology extends StatefulWidget {
  const NewCairoCardiology({Key? key}) : super(key: key);

  @override
  State<NewCairoCardiology> createState() => _NewCairoCardiologyState();
}

class _NewCairoCardiologyState extends State<NewCairoCardiology> {
                  ...
                  GestureDetector(
                    onTap: (){
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => NewCairoCardiologyDoc2(),
                        ),
                      );
                    },
                    child: Container(
                  ...
                  GestureDetector(
                    onTap: (){
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => NewCairoCardiologyDoc3(),
                        ),
                      );
                    },
                    child: Container(
