...
class NasrCityCardiology extends StatefulWidget {
  const NasrCityCardiology({Key? key}) : super(key: key);

  @override
  State<NasrCityCardiology> createState() => _NasrCityCardiologyState();
}

class _NasrCityCardiologyState extends State<NasrCityCardiology> {
                  ...
                  GestureDetector(
                    onTap: (){
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => CardiologyDoctor1(),
                        ),
                      );
                    },
                    child: Container(
                  ...
                  GestureDetector(
                    onTap: (){
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => CardiologyDoctor2(),
                        ),
                      );
                    },
                    child: Container(
                  ...
                  GestureDetector(
                    onTap: (){
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => CardiologyDoctor3(),
                        ),
                      );
                    },
                    child: Container(
