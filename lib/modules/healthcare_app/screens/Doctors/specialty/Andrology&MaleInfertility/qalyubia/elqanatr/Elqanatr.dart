...
class ElqanatrAndrology extends StatefulWidget {
  const ElqanatrAndrology({Key? key}) : super(key: key);

  @override
  State<ElqanatrAndrology> createState() => _ElqanatrAndrologyState();
}

class _ElqanatrAndrologyState extends State<ElqanatrAndrology> {
