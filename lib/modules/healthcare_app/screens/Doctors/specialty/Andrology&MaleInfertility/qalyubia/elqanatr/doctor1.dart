...
class ElqanaterAndrologyDoc1 extends StatelessWidget {
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            child: const Text(
                              'Andrology & Male Infertility Doctor Doctor Doctor',
                              style: TextStyle(
                                color: Colors.black,
                  ...
                  children: [
                    ...
                    Row(
                      children:  [
                        ...
                        const SizedBox(width: 8,),
                        Text(
                          'In the front of mahkamaa above the champs elyees pastry',
                          style: Theme.of(context).textTheme.bodyText2,
                          maxLines: 1,
                          overflow: TextOverflow.ellipsis,
                        ),
