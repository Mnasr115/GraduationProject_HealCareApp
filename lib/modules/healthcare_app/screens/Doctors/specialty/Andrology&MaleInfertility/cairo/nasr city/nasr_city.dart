...
class NasrCityAndrology extends StatefulWidget {


  @override
  State<NasrCityAndrology> createState() => _NasrCityAndrologyState();
}

class _NasrCityAndrologyState extends State<NasrCityAndrology> {
                                ...
                                Column(
                                  ...
                                  children: [
                                    ListTile(
                                      ...
                                      title: const Text('Dr. Tarek El-Gamal'),
                                      subtitle: Column(
                                        crossAxisAlignment: CrossAxisAlignment.start,
                                ...
                                Column(
                                  ...
                                  children: [
                                    ListTile(
                                      ...
                                      title: const Text('Dr.Ahmed Soliman'),
                                      subtitle: Column(
                                        crossAxisAlignment: CrossAxisAlignment.start,
                                        mainAxisAlignment: MainAxisAlignment.center,
                                        children: [
                                ...
                                Column(
                                  ...
                                  children: [
                                    ListTile(
                                      ...
                                      title: const Text('Dr. Hani Al-Bahr'),
                                      subtitle: Column(
                                        crossAxisAlignment: CrossAxisAlignment.start,
                                        mainAxisAlignment: MainAxisAlignment.center,
                                        children: [
