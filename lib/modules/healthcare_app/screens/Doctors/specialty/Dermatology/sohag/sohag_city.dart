...
class SohagDermatology extends StatefulWidget {
  const SohagDermatology({Key? key}) : super(key: key);

  @override
  State<SohagDermatology> createState() => _SohagDermatologyState();
}

class _SohagDermatologyState extends State<SohagDermatology> {
