...
class QalyubiaInsider extends StatelessWidget {
  const QalyubiaInsider({Key? key}) : super(key: key);
                  ...
                  child: GestureDetector(
                    onTap: (){
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context)=> BanhaDermatology(),
                        ),
                      );
                    },
                  ...
                  child: GestureDetector(
                    onTap: (){
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context)=> ElqanatrDermatology(),
                        ),
                      );
                    },
