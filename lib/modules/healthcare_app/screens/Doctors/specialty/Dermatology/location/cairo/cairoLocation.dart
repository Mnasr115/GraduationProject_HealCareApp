...
class CairoInsider extends StatelessWidget {
  const CairoInsider({Key? key}) : super(key: key);
                  ...
                  child: GestureDetector(
                    onTap: (){
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context)=> NasrCityDermatology(),
                        ),
                      );
                    },
                  ...
                  child: GestureDetector(
                    onTap: (){
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context)=> shoubraDermatology(),
                        ),
                      );
                    },
                  ...
                  child: GestureDetector(
                    onTap: (){
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context)=> NewCairoDermatology(),
                        ),
                      );
                    },
