...
class ElqanatrDermatology extends StatefulWidget {
  const ElqanatrDermatology({Key? key}) : super(key: key);

  @override
  State<ElqanatrDermatology> createState() => _ElqanatrDermatologyState();
}

class _ElqanatrDermatologyState extends State<ElqanatrDermatology> {
