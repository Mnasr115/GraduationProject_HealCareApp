...
class NewCairoDermatology extends StatefulWidget {
  const NewCairoDermatology({Key? key}) : super(key: key);

  @override
  State<NewCairoDermatology> createState() => _NewCairoDermatologyState();
}

class _NewCairoDermatologyState extends State<NewCairoDermatology> {
