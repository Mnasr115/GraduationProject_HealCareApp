...
class shoubraDermatology extends StatefulWidget {
  const shoubraDermatology({Key? key}) : super(key: key);

  @override
  State<shoubraDermatology> createState() => _shoubraDermatologyState();
}

class _shoubraDermatologyState extends State<shoubraDermatology> {
