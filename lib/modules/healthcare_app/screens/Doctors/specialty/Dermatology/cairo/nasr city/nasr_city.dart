...
class NasrCityDermatology extends StatefulWidget {
  const NasrCityDermatology({Key? key}) : super(key: key);

  @override
  State<NasrCityDermatology> createState() => _NasrCityDermatologyState();
}

class _NasrCityDermatologyState extends State<NasrCityDermatology> {
