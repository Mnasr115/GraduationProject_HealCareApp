...
class ElqanatrDentistry extends StatefulWidget {
  const ElqanatrDentistry({Key? key}) : super(key: key);

  @override
  State<ElqanatrDentistry> createState() => _ElqanatrDentistryState();
}

class _ElqanatrDentistryState extends State<ElqanatrDentistry> {
