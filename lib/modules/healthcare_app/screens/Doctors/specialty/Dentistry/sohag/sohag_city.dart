...
class SohagDentistry extends StatefulWidget {
  const SohagDentistry({Key? key}) : super(key: key);

  @override
  State<SohagDentistry> createState() => _SohagDentistryState();
}

class _SohagDentistryState extends State<SohagDentistry> {
