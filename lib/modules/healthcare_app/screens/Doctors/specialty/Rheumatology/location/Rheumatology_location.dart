...
import '../Rheumatology_doctors.dart';
import 'cairo/cairoLocation.dart';


class RheumatologyLocation extends StatelessWidget {
  const RheumatologyLocation({Key? key}) : super(key: key);
                  ...
                  child: GestureDetector(
                    onTap: (){
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context)=> RheumatologyDoctors(),
                        ),
                      );
                    },
                  ...
                  child: GestureDetector(
                    onTap: (){
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context)=> QalyubiaReuthmaInsider(),
                        ),
                      );
                    },
