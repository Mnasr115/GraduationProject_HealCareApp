...
class SohagRheumatology extends StatefulWidget {
  const SohagRheumatology({Key? key}) : super(key: key);

  @override
  State<SohagRheumatology> createState() => _SohagRheumatologyState();
}

class _SohagRheumatologyState extends State<SohagRheumatology> {
