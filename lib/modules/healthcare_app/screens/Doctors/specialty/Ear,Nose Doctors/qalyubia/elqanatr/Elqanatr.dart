...
class ElqanatrEar_Nose extends StatefulWidget {
  const ElqanatrEar_Nose({Key? key}) : super(key: key);

  @override
  State<ElqanatrEar_Nose> createState() => _ElqanatrEar_NoseState();
}

class _ElqanatrEar_NoseState extends State<ElqanatrEar_Nose> {
