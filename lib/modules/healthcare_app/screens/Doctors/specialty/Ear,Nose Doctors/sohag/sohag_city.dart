...
class SohagEar_Nose extends StatefulWidget {
  const SohagEar_Nose({Key? key}) : super(key: key);

  @override
  State<SohagEar_Nose> createState() => _SohagEar_NoseState();
}

class _SohagEar_NoseState extends State<SohagEar_Nose> {
