...
class NewCairoEar_Nose extends StatefulWidget {
  const NewCairoEar_Nose({Key? key}) : super(key: key);

  @override
  State<NewCairoEar_Nose> createState() => _NewCairoEar_NoseState();
}

class _NewCairoEar_NoseState extends State<NewCairoEar_Nose> {
                  ...
                  GestureDetector(
                    onTap: (){
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => NewCairoEarDoct2(),
                        ),
                      );
                    },
                    child: Container(
