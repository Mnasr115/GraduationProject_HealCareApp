...
class BoneFunctionDetails extends StatelessWidget {
  const BoneFunctionDetails({Key? key}) : super(key: key);
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                'Rheumatoid factor in  the blood are most'
              ...
              ClipRRect(
                ...
                child: Container(
                  ...
                  child: TextButton(
                    onPressed: (){},
                    child: const Text(
                      'Anti Cyclic Citrullinated Peptide Antibody',style: TextStyle(
                      color: Colors.black,
                    ),
                    ),
                  ),
              ...
              ClipRRect(
                ...
                child: Container(
                  ...
                  child: TextButton(
                    onPressed: (){},
                    child: const Text(
                      'Rheumatoid factor - Quantitative',style: TextStyle(
                      color: Colors.black,
                    ),
                    ),
                  ),
