...
class ShibinSpec1Hosp3 extends StatefulWidget {
  const ShibinSpec1Hosp3({Key? key}) : super(key: key);

  @override
  State<ShibinSpec1Hosp3> createState() => _ShibinSpec1Hosp3State();
}

class _ShibinSpec1Hosp3State extends State<ShibinSpec1Hosp3> {
                  ...
                  GestureDetector(
                    onTap: (){
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => ShibinDoctor1Hosp3(),
                        ),
                      );
                    },
                    child: Container(
