...
class ShibinSpec2Hosp3 extends StatefulWidget {
  const ShibinSpec2Hosp3({Key? key}) : super(key: key);

  @override
  State<ShibinSpec2Hosp3> createState() => _ShibinSpec2Hosp3State();
}

class _ShibinSpec2Hosp3State extends State<ShibinSpec2Hosp3> {
                  ...
                  GestureDetector(
                    onTap: (){
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => ShibinDoctor2Hosp3(),
                        ),
                      );
                    },
                    child: Container(
