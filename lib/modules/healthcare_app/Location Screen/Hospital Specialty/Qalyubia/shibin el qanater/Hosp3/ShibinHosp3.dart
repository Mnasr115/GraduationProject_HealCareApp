import 'package:final_project/modules/healthcare_app/Location%20Screen/Hospital%20Specialty/Qalyubia/shibin%20el%20qanater/Hosp3/spec1/spec_screen.dart';
import 'package:final_project/modules/healthcare_app/Location%20Screen/Hospital%20Specialty/Qalyubia/shibin%20el%20qanater/Hosp3/spec2/spec_screen.dart';
import 'package:final_project/modules/healthcare_app/Location%20Screen/Hospital%20Specialty/Qalyubia/shibin%20el%20qanater/Hosp3/spec3/spec_screen.dart';
...
import 'package:final_project/modules/healthcare_app/Location%20Screen/Hospital%20Specialty/cairo/shoubra/Hosp3/spec1/spec_screen.dart';
import 'package:final_project/modules/healthcare_app/Location%20Screen/Hospital%20Specialty/cairo/shoubra/Hosp3/spec2/spec_screen.dart';
import 'package:final_project/modules/healthcare_app/Location%20Screen/Hospital%20Specialty/cairo/shoubra/Hosp3/spec3/spec_screen.dart';
import 'package:flutter/material.dart';
import 'package:hexcolor/hexcolor.dart';

import '../../../../../../../my_flutter_icon_icons.dart';

class ShibinHosp3 extends StatelessWidget {
  const ShibinHosp3({Key? key}) : super(key: key);
                  ...
                  ListTile(
                    ...
                    onTap: (){
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => const ShibinSpec1Hosp3(),
                        ),
                      );
                    },
                  ),
                  ...
                  ListTile(
                    ...
                    onTap: (){
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => const ShibinSpec2Hosp3(),
                        ),
                      );
                    },
                  ),
                  ...
                  ListTile(
                    ...
                    onTap: (){
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => const ShibinSpec3Hosp3(),
                        ),
                      );
                    },
                  ),
