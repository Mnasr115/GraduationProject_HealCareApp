...
class ShibinSpec3Hosp3 extends StatefulWidget {
  const ShibinSpec3Hosp3({Key? key}) : super(key: key);

  @override
  State<ShibinSpec3Hosp3> createState() => _ShibinSpec3Hosp3State();
}

class _ShibinSpec3Hosp3State extends State<ShibinSpec3Hosp3> {
                  ...
                  GestureDetector(
                    onTap: (){
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => ShibinDoctor3Hosp3(),
                        ),
                      );
                    },
                    child: Container(
