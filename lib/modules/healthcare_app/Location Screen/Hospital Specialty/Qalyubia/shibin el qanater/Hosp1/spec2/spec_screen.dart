...
class ShibinAlQanaterSpec2 extends StatefulWidget {
  const ShibinAlQanaterSpec2({Key? key}) : super(key: key);

  @override
  State<ShibinAlQanaterSpec2> createState() => _ShibinAlQanaterSpec2State();
}

class _ShibinAlQanaterSpec2State extends State<ShibinAlQanaterSpec2> {
