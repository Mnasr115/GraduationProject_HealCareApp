import 'package:final_project/modules/healthcare_app/Location%20Screen/Hospital%20Specialty/Qalyubia/shibin%20el%20qanater/Hosp1/spec1/spec_screen.dart';
import 'package:final_project/modules/healthcare_app/Location%20Screen/Hospital%20Specialty/Qalyubia/shibin%20el%20qanater/Hosp1/spec2/spec_screen.dart';
import 'package:final_project/modules/healthcare_app/Location%20Screen/Hospital%20Specialty/Qalyubia/shibin%20el%20qanater/Hosp1/spec3/spec_screen.dart';
...
class ShibinAlQanaterHosp1 extends StatelessWidget {
  const ShibinAlQanaterHosp1({Key? key}) : super(key: key);
                  ...
                  ListTile(
                    ...
                    onTap: (){
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => const ShibinAlQanaterSpec1(),
                        ),
                      );
                    },
                  ),
                  ...
                  ListTile(
                    ...
                    onTap: (){
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => const ShibinAlQanaterSpec2(),
                        ),
                      );
                    },
                  ),
                  ...
                  ListTile(
                    ...
                    onTap: (){
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => const ShibinAlQanaterSpec3(),
                        ),
                      );
                    },
                  ),
