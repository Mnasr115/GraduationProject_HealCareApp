...
class ShibinSpec3Hosp2 extends StatefulWidget {
  const ShibinSpec3Hosp2({Key? key}) : super(key: key);

  @override
  State<ShibinSpec3Hosp2> createState() => _ShibinSpec3Hosp2State();
}

class _ShibinSpec3Hosp2State extends State<ShibinSpec3Hosp2> {
                  ...
                  GestureDetector(
                    onTap: (){
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => ShibinDoctor3Hosp2(),
                        ),
                      );
                    },
                    child: Container(
