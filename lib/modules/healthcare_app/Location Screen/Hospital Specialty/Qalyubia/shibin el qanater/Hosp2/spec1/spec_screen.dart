...
class ShibinAlQanaterSpec1Hosp2 extends StatefulWidget {
  const ShibinAlQanaterSpec1Hosp2({Key? key}) : super(key: key);

  @override
  State<ShibinAlQanaterSpec1Hosp2> createState() => _ShibinAlQanaterSpec1Hosp2State();
}

class _ShibinAlQanaterSpec1Hosp2State extends State<ShibinAlQanaterSpec1Hosp2> {
                  ...
                  GestureDetector(
                    onTap: (){
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => ShibinDoctor1Hosp2(),
                        ),
                      );
                    },
                    child: Container(
