...
class ShibinSpec2Hosp2 extends StatefulWidget {
  const ShibinSpec2Hosp2({Key? key}) : super(key: key);

  @override
  State<ShibinSpec2Hosp2> createState() => _ShibinSpec2Hosp2State();
}

class _ShibinSpec2Hosp2State extends State<ShibinSpec2Hosp2> {
                  ...
                  GestureDetector(
                    onTap: (){
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => ShibinDoctor2Hosp2(),
                        ),
                      );
                    },
                    child: Container(
