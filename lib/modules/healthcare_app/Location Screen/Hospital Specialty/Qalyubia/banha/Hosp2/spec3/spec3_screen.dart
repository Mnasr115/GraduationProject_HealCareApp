...
class BanhaHosp2Spec3 extends StatefulWidget {
  const BanhaHosp2Spec3({Key? key}) : super(key: key);

  @override
  State<BanhaHosp2Spec3> createState() => _BanhaHosp2Spec3State();
}

class _BanhaHosp2Spec3State extends State<BanhaHosp2Spec3> {
                  ...
                  GestureDetector(
                    onTap: (){
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => BanhaHos2Doctor3(),
                        ),
                      );
                    },
                    child: Container(
