...
class BanhaHosp2Spec2 extends StatefulWidget {
  const BanhaHosp2Spec2({Key? key}) : super(key: key);

  @override
  State<BanhaHosp2Spec2> createState() => _BanhaHosp2Spec2State();
}

class _BanhaHosp2Spec2State extends State<BanhaHosp2Spec2> {
                  ...
                  GestureDetector(
                    onTap: (){
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => BanhaHos2Doctor2(),
                        ),
                      );
                    },
                    child: Container(
