...
class BanhaHosp3Spec3 extends StatefulWidget {
  const BanhaHosp3Spec3({Key? key}) : super(key: key);

  @override
  State<BanhaHosp3Spec3> createState() => _BanhaHosp3Spec3State();
}

class _BanhaHosp3Spec3State extends State<BanhaHosp3Spec3> {
                  ...
                  GestureDetector(
                    onTap: (){
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => BanhaHos3Doctor3(),
                        ),
                      );
                    },
                    child: Container(
