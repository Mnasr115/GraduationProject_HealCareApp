...
class BanhaHosp3Spec1 extends StatefulWidget {
  const BanhaHosp3Spec1({Key? key}) : super(key: key);

  @override
  State<BanhaHosp3Spec1> createState() => _BanhaHosp3Spec1State();
}

class _BanhaHosp3Spec1State extends State<BanhaHosp3Spec1> {
                  ...
                  GestureDetector(
                    onTap: (){
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => BanhaHosp3Doctor1(),
                        ),
                      );
                    },
                    child: Container(
