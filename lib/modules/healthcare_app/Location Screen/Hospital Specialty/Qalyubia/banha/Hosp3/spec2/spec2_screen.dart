...
class BanhaHosp3Spec2 extends StatefulWidget {
  const BanhaHosp3Spec2({Key? key}) : super(key: key);

  @override
  State<BanhaHosp3Spec2> createState() => _BanhaHosp3Spec2State();
}

class _BanhaHosp3Spec2State extends State<BanhaHosp3Spec2> {
                  ...
                  GestureDetector(
                    onTap: (){
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => BanhaHos3Doctor2(),
                        ),
                      );
                    },
                    child: Container(
