...
class BanhaSpec2Screen extends StatefulWidget {
  const BanhaSpec2Screen({Key? key}) : super(key: key);

  @override
  State<BanhaSpec2Screen> createState() => _BanhaSpec2ScreenState();
}

class _BanhaSpec2ScreenState extends State<BanhaSpec2Screen> {
