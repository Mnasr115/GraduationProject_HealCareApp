...
class QalyubSpec2Screen extends StatefulWidget {
  const QalyubSpec2Screen({Key? key}) : super(key: key);

  @override
  State<QalyubSpec2Screen> createState() => _QalyubSpec2ScreenState();
}

class _QalyubSpec2ScreenState extends State<QalyubSpec2Screen> {
