...
class QalyubSpec1Screen extends StatefulWidget {
  const QalyubSpec1Screen({Key? key}) : super(key: key);

  @override
  State<QalyubSpec1Screen> createState() => _QalyubSpec1ScreenState();
}

class _QalyubSpec1ScreenState extends State<QalyubSpec1Screen> {
