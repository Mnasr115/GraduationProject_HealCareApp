...
class QalyubSpec1Hosp3 extends StatefulWidget {
  const QalyubSpec1Hosp3({Key? key}) : super(key: key);

  @override
  State<QalyubSpec1Hosp3> createState() => _QalyubSpec1Hosp3State();
}

class _QalyubSpec1Hosp3State extends State<QalyubSpec1Hosp3> {
                  ...
                  GestureDetector(
                    onTap: (){
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => QalyubDoctor1Hosp3(),
                        ),
                      );
                    },
                    child: Container(
