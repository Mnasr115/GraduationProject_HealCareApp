...
class QalyubSpec3Hosp3 extends StatefulWidget {
  const QalyubSpec3Hosp3({Key? key}) : super(key: key);

  @override
  State<QalyubSpec3Hosp3> createState() => _QalyubSpec3Hosp3State();
}

class _QalyubSpec3Hosp3State extends State<QalyubSpec3Hosp3> {
                  ...
                  GestureDetector(
                    onTap: (){
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => QalyubDoctor3Hosp3(),
                        ),
                      );
                    },
                    child: Container(
