...
class QalyubSpec2Hosp3 extends StatefulWidget {
  const QalyubSpec2Hosp3({Key? key}) : super(key: key);

  @override
  State<QalyubSpec2Hosp3> createState() => _QalyubSpec2Hosp3State();
}

class _QalyubSpec2Hosp3State extends State<QalyubSpec2Hosp3> {
                  ...
                  GestureDetector(
                    onTap: (){
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => QalyubDoctor2Hosp3(),
                        ),
                      );
                    },
                    child: Container(
