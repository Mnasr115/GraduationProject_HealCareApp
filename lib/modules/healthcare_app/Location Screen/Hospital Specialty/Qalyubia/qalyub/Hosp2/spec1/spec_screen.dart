...
class QalyubSpec1Hosp2 extends StatefulWidget {
  const QalyubSpec1Hosp2({Key? key}) : super(key: key);

  @override
  State<QalyubSpec1Hosp2> createState() => _QalyubSpec1Hosp2State();
}

class _QalyubSpec1Hosp2State extends State<QalyubSpec1Hosp2> {
                  ...
                  GestureDetector(
                    onTap: (){
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => QalyubDoctor1Hosp2(),
                        ),
                      );
                    },
                    child: Container(
