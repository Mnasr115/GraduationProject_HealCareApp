...
class QalyubSpec2Hosp2 extends StatefulWidget {
  const QalyubSpec2Hosp2({Key? key}) : super(key: key);

  @override
  State<QalyubSpec2Hosp2> createState() => _QalyubSpec2Hosp2State();
}

class _QalyubSpec2Hosp2State extends State<QalyubSpec2Hosp2> {
                  ...
                  GestureDetector(
                    onTap: (){
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => QalyubDoctor2Hosp2(),
                        ),
                      );
                    },
                    child: Container(
