...
class Hosp3Spec1 extends StatefulWidget {
  const Hosp3Spec1({Key? key}) : super(key: key);

  @override
  State<Hosp3Spec1> createState() => _Hosp3Spec1State();
}

class _Hosp3Spec1State extends State<Hosp3Spec1> {
