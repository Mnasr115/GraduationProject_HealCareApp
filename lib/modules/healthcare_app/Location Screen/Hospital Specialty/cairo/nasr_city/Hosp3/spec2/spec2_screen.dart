...
class Hosp3Spec2 extends StatefulWidget {
  const Hosp3Spec2({Key? key}) : super(key: key);

  @override
  State<Hosp3Spec2> createState() => _Hosp3Spec2State();
}

class _Hosp3Spec2State extends State<Hosp3Spec2> {
