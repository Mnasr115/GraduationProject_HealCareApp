...
class Hosp3Spec3 extends StatefulWidget {
  const Hosp3Spec3({Key? key}) : super(key: key);

  @override
  State<Hosp3Spec3> createState() => _Hosp3Spec3State();
}

class _Hosp3Spec3State extends State<Hosp3Spec3> {
