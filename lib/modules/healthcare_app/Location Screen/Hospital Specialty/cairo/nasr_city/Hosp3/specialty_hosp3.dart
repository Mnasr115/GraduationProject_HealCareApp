...
class SpecialtyHosp3 extends StatelessWidget {
  const SpecialtyHosp3({Key? key}) : super(key: key);
                  ...
                  ListTile(
                    ...
                    onTap: (){
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => const Hosp3Spec1(),
                        ),
                      );
                    },
                  ),
                  ...
                  ListTile(
                    ...
                    onTap: (){
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => const Hosp3Spec2(),
                        ),
                      );
                    },
                  ),
                  ...
                  ListTile(
                    ...
                    onTap: (){
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => const Hosp3Spec3(),
                        ),
                      );
                    },
                  ),
