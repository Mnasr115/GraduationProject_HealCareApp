...
class Spec2Screen extends StatefulWidget {
  const Spec2Screen({Key? key}) : super(key: key);

  @override
  State<Spec2Screen> createState() => _Spec2ScreenState();
}

class _Spec2ScreenState extends State<Spec2Screen> {
