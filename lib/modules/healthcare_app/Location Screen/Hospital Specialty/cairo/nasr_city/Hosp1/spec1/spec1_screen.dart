...
class Spec1Screen extends StatefulWidget {
  const Spec1Screen({Key? key}) : super(key: key);

  @override
  State<Spec1Screen> createState() => _Spec1ScreenState();
}

class _Spec1ScreenState extends State<Spec1Screen> {
