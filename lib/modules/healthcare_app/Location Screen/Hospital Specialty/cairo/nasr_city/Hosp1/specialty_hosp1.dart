...
class SpecialtyHosp1 extends StatelessWidget {
  const SpecialtyHosp1({Key? key}) : super(key: key);
                  ...
                  ListTile(
                    ...
                    onTap: (){
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => const Spec1Screen(),
                        ),
                      );
                    },
                  ),
                  ...
                  ListTile(
                    ...
                    onTap: (){
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => const Spec2Screen(),
                        ),
                      );
                    },
                  ),
                  ...
                  ListTile(
                    ...
                    onTap: (){
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => const Spec3Screen(),
                        ),
                      );
                    },
                  ),
