...
class Hosp2Spec1 extends StatefulWidget {
  const Hosp2Spec1({Key? key}) : super(key: key);

  @override
  State<Hosp2Spec1> createState() => _Hosp2Spec1State();
}

class _Hosp2Spec1State extends State<Hosp2Spec1> {
