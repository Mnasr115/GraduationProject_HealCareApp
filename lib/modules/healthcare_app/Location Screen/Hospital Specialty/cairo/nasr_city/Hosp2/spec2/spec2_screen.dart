...
class Hosp2Spec2 extends StatefulWidget {
  const Hosp2Spec2({Key? key}) : super(key: key);

  @override
  State<Hosp2Spec2> createState() => _Hosp2Spec2State();
}

class _Hosp2Spec2State extends State<Hosp2Spec2> {
