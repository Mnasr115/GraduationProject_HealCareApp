...
class NewCairoSpec1Hosp3 extends StatefulWidget {
  const NewCairoSpec1Hosp3({Key? key}) : super(key: key);

  @override
  State<NewCairoSpec1Hosp3> createState() => _NewCairoSpec1Hosp3State();
}

class _NewCairoSpec1Hosp3State extends State<NewCairoSpec1Hosp3> {
                  ...
                  GestureDetector(
                    onTap: (){
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => NewCairoDoctor1Hosp3(),
                        ),
                      );
                    },
                    child: Container(
