...
class NewCairoSpec3Hosp3 extends StatefulWidget {
  const NewCairoSpec3Hosp3({Key? key}) : super(key: key);

  @override
  State<NewCairoSpec3Hosp3> createState() => _NewCairoSpec3Hosp3State();
}

class _NewCairoSpec3Hosp3State extends State<NewCairoSpec3Hosp3> {
                  ...
                  GestureDetector(
                    onTap: (){
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => NewCairoDoctor3Hosp3(),
                        ),
                      );
                    },
                    child: Container(
