...
class NewCairoSpec2Hosp3 extends StatefulWidget {
  const NewCairoSpec2Hosp3({Key? key}) : super(key: key);

  @override
  State<NewCairoSpec2Hosp3> createState() => _NewCairoSpec2Hosp3State();
}

class _NewCairoSpec2Hosp3State extends State<NewCairoSpec2Hosp3> {
                  ...
                  GestureDetector(
                    onTap: (){
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => NewCairoDoctor2Hosp3(),
                        ),
                      );
                    },
                    child: Container(
