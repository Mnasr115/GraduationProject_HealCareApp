...
class NewCairoSpec2Hosp2 extends StatefulWidget {
  const NewCairoSpec2Hosp2({Key? key}) : super(key: key);

  @override
  State<NewCairoSpec2Hosp2> createState() => _NewCairoSpec2Hosp2State();
}

class _NewCairoSpec2Hosp2State extends State<NewCairoSpec2Hosp2> {
                  ...
                  GestureDetector(
                    onTap: (){
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => NewCairoDoctor2Hosp2(),
                        ),
                      );
                    },
                    child: Container(
