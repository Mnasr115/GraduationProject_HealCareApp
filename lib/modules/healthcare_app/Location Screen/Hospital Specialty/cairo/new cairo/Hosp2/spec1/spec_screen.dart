...
class NewCairoSpec1Hosp2 extends StatefulWidget {
  const NewCairoSpec1Hosp2({Key? key}) : super(key: key);

  @override
  State<NewCairoSpec1Hosp2> createState() => _NewCairoSpec1Hosp2State();
}

class _NewCairoSpec1Hosp2State extends State<NewCairoSpec1Hosp2> {
                  ...
                  GestureDetector(
                    onTap: (){
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => NewCairoDoctor1Hosp2(),
                        ),
                      );
                    },
                    child: Container(
