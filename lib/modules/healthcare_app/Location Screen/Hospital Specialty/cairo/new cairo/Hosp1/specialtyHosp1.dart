...
class NewCairoSpecialtyHosp1 extends StatelessWidget {
  const NewCairoSpecialtyHosp1({Key? key}) : super(key: key);
                  ...
                  ListTile(
                    ...
                    onTap: (){
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => const NewCairoSpec1Screen(),
                        ),
                      );
                    },
                  ),
                  ...
                  ListTile(
                    ...
                    onTap: (){
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => const NewCairoSpec2Screen(),
                        ),
                      );
                    },
                  ),
