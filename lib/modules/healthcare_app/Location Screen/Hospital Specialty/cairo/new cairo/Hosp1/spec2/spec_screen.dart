...
import '../../../../../../screens/Doctors/specialty/Dentistry/cairo/new cairo/doctor2.dart';




class NewCairoSpec2Screen extends StatefulWidget {
  const NewCairoSpec2Screen({Key? key}) : super(key: key);

  @override
  State<NewCairoSpec2Screen> createState() => _NewCairoSpec2ScreenState();
}

class _NewCairoSpec2ScreenState extends State<NewCairoSpec2Screen> {
