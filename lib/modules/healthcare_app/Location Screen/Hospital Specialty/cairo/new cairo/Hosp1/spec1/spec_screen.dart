...
class NewCairoSpec1Screen extends StatefulWidget {
  const NewCairoSpec1Screen({Key? key}) : super(key: key);

  @override
  State<NewCairoSpec1Screen> createState() => _NewCairoSpec1ScreenState();
}

class _NewCairoSpec1ScreenState extends State<NewCairoSpec1Screen> {
