...
class ShoubraSpec2Hosp2 extends StatefulWidget {
  const ShoubraSpec2Hosp2({Key? key}) : super(key: key);

  @override
  State<ShoubraSpec2Hosp2> createState() => _ShoubraSpec2Hosp2State();
}

class _ShoubraSpec2Hosp2State extends State<ShoubraSpec2Hosp2> {
                  ...
                  GestureDetector(
                    onTap: (){
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => ShoubraDoctor2Hosp2(),
                        ),
                      );
                    },
                    child: Container(
