...
class ShoubraSpec1Hosp2 extends StatefulWidget {
  const ShoubraSpec1Hosp2({Key? key}) : super(key: key);

  @override
  State<ShoubraSpec1Hosp2> createState() => _ShoubraSpec1Hosp2State();
}

class _ShoubraSpec1Hosp2State extends State<ShoubraSpec1Hosp2> {
                  ...
                  GestureDetector(
                    onTap: (){
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => ShoubraDoctor1Hosp2(),
                        ),
                      );
                    },
                    child: Container(
