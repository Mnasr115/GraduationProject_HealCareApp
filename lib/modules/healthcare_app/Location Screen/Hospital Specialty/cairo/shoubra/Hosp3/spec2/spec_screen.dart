...
class ShoubraSpec2Hosp3 extends StatefulWidget {
  const ShoubraSpec2Hosp3({Key? key}) : super(key: key);

  @override
  State<ShoubraSpec2Hosp3> createState() => _ShoubraSpec2Hosp3State();
}

class _ShoubraSpec2Hosp3State extends State<ShoubraSpec2Hosp3> {
                  ...
                  GestureDetector(
                    onTap: (){
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => ShoubraDoctor2Hosp3(),
                        ),
                      );
                    },
                    child: Container(
