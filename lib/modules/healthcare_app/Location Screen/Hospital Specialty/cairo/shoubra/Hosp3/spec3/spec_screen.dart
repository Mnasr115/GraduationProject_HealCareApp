...
class ShoubraSpec3Hosp3 extends StatefulWidget {
  const ShoubraSpec3Hosp3({Key? key}) : super(key: key);

  @override
  State<ShoubraSpec3Hosp3> createState() => _ShoubraSpec3Hosp3State();
}

class _ShoubraSpec3Hosp3State extends State<ShoubraSpec3Hosp3> {
                  ...
                  GestureDetector(
                    onTap: (){
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => ShoubraDoctor3Hosp3(),
                        ),
                      );
                    },
                    child: Container(
