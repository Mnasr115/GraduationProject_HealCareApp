...
class ShoubraSpec1Hosp3 extends StatefulWidget {
  const ShoubraSpec1Hosp3({Key? key}) : super(key: key);

  @override
  State<ShoubraSpec1Hosp3> createState() => _ShoubraSpec1Hosp3State();
}

class _ShoubraSpec1Hosp3State extends State<ShoubraSpec1Hosp3> {
                  ...
                  GestureDetector(
                    onTap: (){
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => ShoubraDoctor1Hosp3(),
                        ),
                      );
                    },
                    child: Container(
