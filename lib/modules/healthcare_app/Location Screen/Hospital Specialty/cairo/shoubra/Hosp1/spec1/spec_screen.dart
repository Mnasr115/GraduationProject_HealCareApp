...
class ShoubraSpec1Screen extends StatefulWidget {
  const ShoubraSpec1Screen({Key? key}) : super(key: key);

  @override
  State<ShoubraSpec1Screen> createState() => _ShoubraSpec1ScreenState();
}

class _ShoubraSpec1ScreenState extends State<ShoubraSpec1Screen> {
