...
class ShoubraSpec3Screen extends StatefulWidget {
  const ShoubraSpec3Screen({Key? key}) : super(key: key);

  @override
  State<ShoubraSpec3Screen> createState() => _ShoubraSpec3ScreenState();
}

class _ShoubraSpec3ScreenState extends State<ShoubraSpec3Screen> {
                                        ...
                                        child: MaterialButton(
                                          ...
                                          onPressed: (){
                                            Navigator.push(
                                              context,
                                              MaterialPageRoute(
                                                builder: (context) => ShoubraDoctor3(),
                                              ),
                                            );
                                          },
                                          color: Colors.red,
