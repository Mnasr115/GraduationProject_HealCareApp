...
class SohagHosp2Spec2 extends StatefulWidget {
  const SohagHosp2Spec2({Key? key}) : super(key: key);

  @override
  State<SohagHosp2Spec2> createState() => _SohagHosp2Spec2State();
}

class _SohagHosp2Spec2State extends State<SohagHosp2Spec2> {
                  ...
                  GestureDetector(
                    onTap: (){
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => SohagHos2Doctor2(),
                        ),
                      );
                    },
                    child: Container(
