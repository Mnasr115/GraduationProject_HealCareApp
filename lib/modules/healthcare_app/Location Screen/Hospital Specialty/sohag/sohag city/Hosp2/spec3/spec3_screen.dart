...
class SohagHosp2Spec3 extends StatefulWidget {
  const SohagHosp2Spec3({Key? key}) : super(key: key);

  @override
  State<SohagHosp2Spec3> createState() => _SohagHosp2Spec3State();
}

class _SohagHosp2Spec3State extends State<SohagHosp2Spec3> {
                  ...
                  GestureDetector(
                    onTap: (){
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => SohagHos2Doctor3(),
                        ),
                      );
                    },
                    child: Container(
