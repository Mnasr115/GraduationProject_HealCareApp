...
class SohagHosp2Spec1 extends StatefulWidget {
  const SohagHosp2Spec1({Key? key}) : super(key: key);

  @override
  State<SohagHosp2Spec1> createState() => _SohagHosp2Spec1State();
}

class _SohagHosp2Spec1State extends State<SohagHosp2Spec1> {
