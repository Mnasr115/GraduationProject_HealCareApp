...
import '../../../../cairo/nasr_city/Hosp1/spec1/doctor.dart';
import 'doctor.dart';




class SohagSpec1Screen extends StatefulWidget {
  const SohagSpec1Screen({Key? key}) : super(key: key);

  @override
  State<SohagSpec1Screen> createState() => _SohagSpec1ScreenState();
}

class _SohagSpec1ScreenState extends State<SohagSpec1Screen> {
