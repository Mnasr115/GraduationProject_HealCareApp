...
class SohagSpec2Screen extends StatefulWidget {
  const SohagSpec2Screen({Key? key}) : super(key: key);

  @override
  State<SohagSpec2Screen> createState() => _SohagSpec2ScreenState();
}

class _SohagSpec2ScreenState extends State<SohagSpec2Screen> {
