...
class SohagSpec3Screen extends StatefulWidget {
  const SohagSpec3Screen({Key? key}) : super(key: key);

  @override
  State<SohagSpec3Screen> createState() => _SohagSpec3ScreenState();
}

class _SohagSpec3ScreenState extends State<SohagSpec3Screen> {
