...
class SohagHosp3Spec3 extends StatefulWidget {
  const SohagHosp3Spec3({Key? key}) : super(key: key);

  @override
  State<SohagHosp3Spec3> createState() => _SohagHosp3Spec3State();
}

class _SohagHosp3Spec3State extends State<SohagHosp3Spec3> {
                  ...
                  GestureDetector(
                    onTap: (){
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => SohagHos3Doctor3(),
                        ),
                      );
                    },
                    child: Container(
