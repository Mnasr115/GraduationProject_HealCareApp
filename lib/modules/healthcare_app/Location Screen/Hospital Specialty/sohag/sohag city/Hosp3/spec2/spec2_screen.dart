...
class SohagHosp3Spec2 extends StatefulWidget {
  const SohagHosp3Spec2({Key? key}) : super(key: key);

  @override
  State<SohagHosp3Spec2> createState() => _SohagHosp3Spec2State();
}

class _SohagHosp3Spec2State extends State<SohagHosp3Spec2> {
                  ...
                  GestureDetector(
                    onTap: (){
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => SohagHos3Doctor2(),
                        ),
                      );
                    },
                    child: Container(
