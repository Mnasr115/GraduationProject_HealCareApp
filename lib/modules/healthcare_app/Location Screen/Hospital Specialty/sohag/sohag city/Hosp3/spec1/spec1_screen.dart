...
class SohagHosp3Spec1 extends StatefulWidget {
  const SohagHosp3Spec1({Key? key}) : super(key: key);

  @override
  State<SohagHosp3Spec1> createState() => _SohagHosp3Spec1State();
}

class _SohagHosp3Spec1State extends State<SohagHosp3Spec1> {
                  ...
                  GestureDetector(
                    onTap: (){
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => SohagHosp3Doctor1(),
                        ),
                      );
                    },
                    child: Container(
